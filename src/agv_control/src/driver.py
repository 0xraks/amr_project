...
class Driver:
    def __init__(self):
        ...
        self._wheel_base = rospy.get_param('~wheel_base', 0.0635)
    ...
    def _velocity_received_callback(self, message):
        ...
        left_speed = 1.11*(linear - 4*angular*self._wheel_base/2 )
        right_speed = (linear + 4*angular*self._wheel_base/2)
